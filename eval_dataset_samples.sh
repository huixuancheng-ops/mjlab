...
SAMPLE_DIR="/home/huixuan_cheng/diff_weight/dataset/g1dance1s2/checkpoint"
MOTION_FILE="/home/huixuan_cheng/mjlab/artifacts/dance1s2:v0/motion.npz"
DEFAULT_EVAL_SUBDIR_NAME="eval"
...
if [[ -z "$OUTPUT_DIR" ]]; then
  OUT_SUBDIR="${SAMPLE_DIR}/${DEFAULT_EVAL_SUBDIR_NAME}"
else
...
# Sort to make "first N" deterministic.
IFS=$'\n' samples=($(printf '%s\n' "${samples[@]}" | sort))
unset IFS
